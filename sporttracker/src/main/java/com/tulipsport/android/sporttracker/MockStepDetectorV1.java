...
public class MockStepDetectorV1 implements IMockStepRecognizer {
    ...
    public MockStepDetectorV1(StepListener stepListener) {
        int h = 480;
        mYOffset = h * 0.5f;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        synchronized (this) {
            if (System.currentTimeMillis() - lastAcceptTime < 300) return;
